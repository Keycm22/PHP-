...
<body>
    ...
    <main>
        ...
        <section class="full-menu-image-section common-padding">
            <div class="container" style="text-align: center;">
                <h2 class="section-heading">OUR MENU</h2>
                <img src="images/menu.jpg" alt="Tavern Publico Full Menu" class="full-menu-image" style="width: 1480px; height: 1650px; max-width: 100%; height: auto; display: block; margin: 0 auto;">
                <p class="menu-note" style="margin-top: 30px;">
